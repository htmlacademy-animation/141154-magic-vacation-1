...
/***/ "./source/js/helpers/2d/Animation.js":
/*!*******************************************!*\
  !*** ./source/js/helpers/2d/Animation.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _utils_easing_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/easing.js */ "./source/js/helpers/utils/easing.js");
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _utils_easing_js__WEBPACK_IMPORTED_MODULE_0__["default"].easeLinear;
    }
...
/***/ "./source/js/helpers/2d/CrocodileScene.js":
/*!************************************************!*\
  !*** ./source/js/helpers/2d/CrocodileScene.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Animation.js */ "./source/js/helpers/2d/Animation.js");
/* harmony import */ var _Scene_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Scene.js */ "./source/js/helpers/2d/Scene.js");
/* harmony import */ var _utils_easing_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/easing.js */ "./source/js/helpers/utils/easing.js");
...
class CrocodileScene extends _Scene_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(canvas) {
    super({
      canvas,
      objects: OBJECTS,
  ...
  initCrocodileAnimations() {
    ...
    this.animations.push(new _Animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      easing: _utils_easing_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutCubic,
      callback: () => {
  ...
  initDropAnimations() {
    ...
    let animation = new _Animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: (progress) => {
        const progressReversed = 1 - progress;
      ...
      easing: _utils_easing_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInCubic,
    });
...
class Scene {
    ...
    resize() {
      this.size = Math.min(document.body.clientWidth, document.body.clientHeight);
...
/***/ "./source/js/helpers/2d/SeaCalfScene.js":
/*!**********************************************!*\
  !*** ./source/js/helpers/2d/SeaCalfScene.js ***!
  \**********************************************/
/*! exports provided: default */
...
class SeaCalfScene extends _Scene_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(canvas) {
    super({
      canvas,
      objects: OBJECTS,
  ...
  initPlaneAnimations() {
    this.animations.push(new _Animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      easing: _utils_easing_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _Animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 2000,
      delay: this._DELAY_START + 200,
      easing: _utils_easing_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/***/ "./source/js/helpers/StringBuilder.js":
/*!********************************************!*\
  !*** ./source/js/helpers/StringBuilder.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StringBuilder; });
class StringBuilder {
...
/***/ "./source/js/helpers/TextAnimation.js":
/*!********************************************!*\
  !*** ./source/js/helpers/TextAnimation.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./source/js/helpers/utils/easing.js":
/*!*******************************************!*\
  !*** ./source/js/helpers/utils/easing.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _helpers_StringBuilder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/StringBuilder */ "./source/js/helpers/StringBuilder.js");
/* harmony import */ var _helpers_TextAnimation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/TextAnimation */ "./source/js/helpers/TextAnimation.js");
/* harmony import */ var _helpers_Timer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/Timer */ "./source/js/helpers/Timer.js");
/* harmony import */ var _result__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./result */ "./source/js/modules/result.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.introTitle = new _helpers_StringBuilder__WEBPACK_IMPORTED_MODULE_1__["default"](introTitle, {
        wordClass: 'text--word',
    ...
    this.introDate = new _helpers_StringBuilder__WEBPACK_IMPORTED_MODULE_1__["default"](introDate, {
      wordClass: 'text--word',
      activateClass: 'active__title',
      property: 'transform',
      delay: 700
    ...
    this.gameTimer = new _helpers_Timer__WEBPACK_IMPORTED_MODULE_3__["default"]({
      nodesList: timerNode.children,
      time: 300000,
      endCB: () => { Object(_result__WEBPACK_IMPORTED_MODULE_4__["default"])(RESULT3); }
    });

    this.codesCounter = new _helpers_TextAnimation__WEBPACK_IMPORTED_MODULE_2__["default"]({
      node: codesNumField,
      start: 11,
    ...
    this.casesCounter = new _helpers_TextAnimation__WEBPACK_IMPORTED_MODULE_2__["default"]({
      node: casesNumField,
      start: 0,
    ...
    this.journeysCounter = new _helpers_TextAnimation__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_2d_SeaCalfScene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/2d/SeaCalfScene */ "./source/js/helpers/2d/SeaCalfScene.js");
/* harmony import */ var _helpers_2d_CrocodileScene__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/2d/CrocodileScene */ "./source/js/helpers/2d/CrocodileScene.js");
  ...
  if (results.length) {
    ...
    switch (result) {
      case "result":
        ...
        resultScene = new _helpers_2d_SeaCalfScene__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById('result1-bg'));
        resultScene.play();
      break;
      case "result2":
      ...
      case "result3":
        ...
        resultScene = new _helpers_2d_CrocodileScene__WEBPACK_IMPORTED_MODULE_1__["default"](document.getElementById('result3-bg'));
        resultScene.play();
      break;
    }
  }
